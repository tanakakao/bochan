...
- missing-value deletion or imputation when the installed optional dependencies support it;
...
- keep README files aligned with the implementation registry and public API.
