...
[Theory index](../README.md) · **English** · [日本語](../ja/README.md)
...
### Acquisition-function supplements

These focused chapters extend Chapter 03 without changing the main reading sequence.

| File | Topic |
|---|---|
| `03b_information_theoretic_acquisitions.md` | Information-theoretic acquisition functions. |
| `03c_knowledge_gradient.md` | Knowledge Gradient. |
| `03d_multiobjective_entropy_search.md` | Multi-objective entropy search. |
| `03e_binary_knowledge_gradient.md` | Knowledge Gradient for binary outputs. |
| `03f_ordinal_knowledge_gradient.md` | Knowledge Gradient for ordinal outputs. |
