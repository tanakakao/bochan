...
This directory mirrors the Japanese theory tree and connects mathematical formulation, probabilistic modeling, sequential decision criteria, implementation contracts, and materials-discovery workflows.
...
## Part III. Materials foundations
...
The recommended default reading path is `00 -> 01 -> 02 -> 03`, followed by the model-selection and application chapters relevant to the task.