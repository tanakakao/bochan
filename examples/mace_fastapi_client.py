"""Minimal client for the MACE structure-aware FastAPI surface."""
...
BASE_URL = "http://127.0.0.1:8000/api/v1/tabular/mace/models"
...
def main() -> None:
    ...
    print("mace metadata:", fitted["metadata"]["mace"])
