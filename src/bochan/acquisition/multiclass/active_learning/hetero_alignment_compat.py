...
_ORIGINAL_COMBINE_ATTR = "_bochan_original_combine_score_and_weight_before_alignment_compat"
...
def apply_hetero_noise_alignment_compat() -> None:
...
__all__ = ["apply_hetero_noise_alignment_compat"]
