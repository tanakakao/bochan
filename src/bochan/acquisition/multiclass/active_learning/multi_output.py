...
class _MultiOutputMulticlassAcqBase(AcquisitionFunction):
    ...
    It evaluates the corresponding single-output multiclass acquisition on each
    submodel and then reduces the output-wise acquisition values.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.sub_acqfs: list[AcquisitionFunction] = [
            self.single_output_acqf_cls(submodel, **self.acqf_kwargs) for submodel in self._submodels()
        ]
