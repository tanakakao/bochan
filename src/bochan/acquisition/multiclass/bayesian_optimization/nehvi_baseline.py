"""InputPerturbation support for multiclass qNEHVI baselines."""
...
def configure_multiclass_nehvi_baseline_input(module: Any) -> None:
    ...
    @wraps(original)
    def supported_baseline_partitioning(
        *,
        model,
        X_baseline: Tensor,
        ref_point: Tensor,
    ...
    supported_baseline_partitioning._bochan_nehvi_baseline_input_patched = True
    supported_baseline_partitioning._bochan_original = original
    module._baseline_partitioning_from_model = supported_baseline_partitioning


__all__ = ["configure_multiclass_nehvi_baseline_input"]
