"""InputPerturbation compatibility for multiclass qNParEGO."""
...
def patch_multiclass_nparego_input_perturbation(module: Any) -> None:
    ...
    @wraps(original_init)
    def compatible_init(self, model, X_baseline: Tensor, ref_point, *args, **kwargs):
...
__all__ = ["patch_multiclass_nparego_input_perturbation"]
