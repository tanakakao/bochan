"""Observed-baseline compatibility for multiclass qNParEGO."""
...
def patch_multiclass_nparego_observed_baseline(module: Any) -> None:
...
__all__ = ["patch_multiclass_nparego_observed_baseline"]
