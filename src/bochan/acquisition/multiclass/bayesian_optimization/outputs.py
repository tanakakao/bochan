...
_ORIGINAL_FORWARD_ATTR = "_bochan_original_forward_before_outputs"
_ORIGINAL_DIRECT_FINALIZE_ATTR = (
    "_bochan_original_finalize_before_outputs"
)
_ORIGINAL_OBJECTIVE_CANONICALIZE_ATTR = (
    "_bochan_original_canonicalize_probability_samples"
)
_ORIGINAL_OBJECTIVE_FORWARD_ATTR = (
    "_bochan_original_forward_before_q_axis_support"
)
...
def _patch_direct_multioutput_finalize() -> None:
    ...
    existing output support helper is reached.
    """
...
def apply_bayesian_optimization_outputs() -> None:
...
__all__ = ["apply_bayesian_optimization_outputs"]
