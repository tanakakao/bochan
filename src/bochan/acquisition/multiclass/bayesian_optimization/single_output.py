...
from bochan.acquisition.multiclass.base import ClassReductionType, ReductionType, _MulticlassAcquisitionBase
    ...
    def __init__(
        ...
        *,
        ...
        if target_class is None:
            raise ValueError("target_class must be specified for multiclass Bayesian optimization acquisitions.")
