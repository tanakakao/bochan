...
class _MultiOutputMulticlassLevelSetBase(AcquisitionFunction):
    """Base wrapper for multiple multiclass level-set outputs."""
...
class qMultiOutputMulticlassLatentStraddleAcquisition(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassLatentStraddleAcquisition


class qMultiOutputMulticlassJointLatentStraddleAcquisition(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassJointLatentStraddleAcquisition


class qMultiOutputMulticlassICUAcquisition(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassICUAcquisition


class qMultiOutputMulticlassBoundaryVarianceAcquisition(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassBoundaryVarianceAcquisition


class qMultiOutputMulticlassClassEntropyAcquisition(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassClassEntropyAcquisition


class qMultiOutputMulticlassProbabilityOfExceedance(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassProbabilityOfExceedance


class qMultiOutputMulticlassLevelSetUncertainty(_MultiOutputMulticlassLevelSetBase):
    single_output_acqf_cls = qMulticlassLevelSetUncertainty
