...
_MODEL_REGISTRY_TREE: RegistryTree = {
    "normal": {
        "regression": {
            ...
            "beta_multitask": ("bochan.models.regression.non_gaussian.beta.base", "WideBetaMultiTaskGPModel"),
            ...
            "poisson_multitask": ("bochan.models.regression.non_gaussian.poisson.base", "WidePoissonMultiTaskGPModel"),
            ...
            "negative_binomial_multitask": ("bochan.models.regression.non_gaussian.negative_binomial.base", "WideNegativeBinomialMultiTaskGPModel"),
        },
        "multi_objective": {
            "base": ("botorch.models.gp_regression", "SingleTaskGP"),
            "kronecker": (
