...
_MODEL_REGISTRY_TREE: RegistryTree = {
    "normal": {
        "regression": {
            ...
            "roost_gp": ("bochan.models.regression.gaussian.deep", "RoostGPModel"),
            "roost_dkl": ("bochan.models.regression.gaussian.deep", "RoostDKLModel"),
            ...
            "beta_base": ("bochan.models.regression.beta.base", "BetaGPModel"),
            "beta_deepgp": ("bochan.models.regression.beta.deep", "DeepBetaGPModel"),
            "beta_deepkernel": ("bochan.models.regression.beta.deep", "DeepKernelBetaGPModel"),
            "beta_saas": ("bochan.models.regression.beta.high_dim", "SaasBetaGPModel"),
            "beta_pca": ("bochan.models.regression.beta.high_dim", "PCABetaGPModel"),
            "beta_rembo": ("bochan.models.regression.beta.high_dim", "REMBOBetaGPModel"),
            "beta_rrp": ("bochan.models.regression.beta.robust", "RobustRelevancePursuitBetaGPModel"),
            "beta_hetero": ("bochan.models.regression.beta.robust", "HeteroscedasticBetaGPModel"),
            "beta_multitask": ("bochan.models.regression.beta.base", "BetaMultiTaskGPModel"),
            "beta_wide_multitask": ("bochan.models.regression.beta.base", "WideBetaMultiTaskGPModel"),
            "beta_kronecker": ("bochan.models.regression.beta.base", "KroneckerMultiTaskBetaGPModel"),
            "gamma_base": ("bochan.models.regression.gamma.base", "GammaGPModel"),
            "gamma_deepgp": ("bochan.models.regression.gamma.deep", "DeepGammaGPModel"),
            "gamma_deepkernel": ("bochan.models.regression.gamma.deep", "DeepKernelGammaGPModel"),
            "gamma_saas": ("bochan.models.regression.gamma.high_dim", "SaasGammaGPModel"),
            "gamma_pca": ("bochan.models.regression.gamma.high_dim", "PCAGammaGPModel"),
            "gamma_rembo": ("bochan.models.regression.gamma.high_dim", "REMBOGammaGPModel"),
            "gamma_rrp": ("bochan.models.regression.gamma.robust", "RobustRelevancePursuitGammaGPModel"),
            "gamma_hetero": ("bochan.models.regression.gamma.robust", "HeteroscedasticGammaGPModel"),
            "gamma_multitask": ("bochan.models.regression.gamma.base", "GammaMultiTaskGPModel"),
            "gamma_wide_multitask": ("bochan.models.regression.gamma.base", "WideGammaMultiTaskGPModel"),
            "gamma_kronecker": ("bochan.models.regression.gamma.base", "KroneckerMultiTaskGammaGPModel"),
            "poisson_base": ("bochan.models.regression.count.poisson.base", "PoissonGPModel"),
            "poisson_deepgp": ("bochan.models.regression.count.poisson.deep", "DeepPoissonGPModel"),
            "poisson_deepkernel": ("bochan.models.regression.count.poisson.deep", "DeepKernelPoissonGPModel"),
            "poisson_saas": ("bochan.models.regression.count.poisson.high_dim", "SaasPoissonGPModel"),
            "poisson_pca": ("bochan.models.regression.count.poisson.high_dim", "PCAPoissonGPModel"),
            "poisson_rembo": ("bochan.models.regression.count.poisson.high_dim", "REMBOPoissonGPModel"),
            "poisson_rrp": ("bochan.models.regression.count.poisson.robust", "RobustRelevancePursuitPoissonGPModel"),
            "poisson_hetero": ("bochan.models.regression.count.poisson.robust", "HeteroscedasticPoissonGPModel"),
            "poisson_multitask": ("bochan.models.regression.count.poisson.base", "PoissonMultiTaskGPModel"),
            "poisson_wide_multitask": ("bochan.models.regression.count.poisson.base", "WidePoissonMultiTaskGPModel"),
            "poisson_kronecker": ("bochan.models.regression.count.poisson.base", "KroneckerMultiTaskPoissonGPModel"),
            "negative_binomial_base": ("bochan.models.regression.count.negative_binomial.base", "NegativeBinomialGPModel"),
            "negative_binomial_deepgp": ("bochan.models.regression.count.negative_binomial.deep", "DeepNegativeBinomialGPModel"),
            "negative_binomial_deepkernel": ("bochan.models.regression.count.negative_binomial.deep", "DeepKernelNegativeBinomialGPModel"),
            "negative_binomial_saas": ("bochan.models.regression.count.negative_binomial.high_dim", "SaasNegativeBinomialGPModel"),
            "negative_binomial_pca": ("bochan.models.regression.count.negative_binomial.high_dim", "PCANegativeBinomialGPModel"),
            "negative_binomial_rembo": ("bochan.models.regression.count.negative_binomial.high_dim", "REMBONegativeBinomialGPModel"),
            "negative_binomial_rrp": ("bochan.models.regression.count.negative_binomial.robust", "RobustRelevancePursuitNegativeBinomialGPModel"),
            "negative_binomial_hetero": ("bochan.models.regression.count.negative_binomial.robust", "HeteroscedasticNegativeBinomialGPModel"),
            "negative_binomial_multitask": ("bochan.models.regression.count.negative_binomial.base", "NegativeBinomialMultiTaskGPModel"),
            "negative_binomial_wide_multitask": ("bochan.models.regression.count.negative_binomial.base", "WideNegativeBinomialMultiTaskGPModel"),
            "negative_binomial_kronecker": ("bochan.models.regression.count.negative_binomial.base", "KroneckerMultiTaskNegativeBinomialGPModel"),
        },
        "multi_objective": {
            "base": ("botorch.models.gp_regression", "SingleTaskGP"),
            "kronecker": (
    ...
    "mixed": {
        "regression": {
            ...
            "beta_base": ("bochan.models.regression.beta.base", "BetaMixedGPModel"),
            "beta_deepgp": ("bochan.models.regression.beta.deep", "DeepBetaMixedGPModel"),
            ...
            "gamma_deepgp": ("bochan.models.regression.gamma.deep", "DeepGammaMixedGPModel"),
            ...
            "poisson_deepgp": ("bochan.models.regression.count.poisson.deep", "DeepPoissonMixedGPModel"),
            "poisson_deepkernel": ("bochan.models.regression.count.poisson.deep", "DeepKernelPoissonMixedGPModel"),
            "poisson_saas": ("bochan.models.regression.count.poisson.high_dim", "SaasPoissonMixedGPModel"),
            "poisson_pca": ("bochan.models.regression.count.poisson.high_dim", "PCAPoissonMixedGPModel"),
            "poisson_rembo": ("bochan.models.regression.count.poisson.high_dim", "REMBOPoissonMixedGPModel"),
            "poisson_rrp": ("bochan.models.regression.count.poisson.robust", "RobustRelevancePursuitPoissonMixedGPModel"),
            "poisson_hetero": ("bochan.models.regression.count.poisson.robust", "HeteroscedasticPoissonMixedGPModel"),
            "negative_binomial_base": ("bochan.models.regression.count.negative_binomial.base", "NegativeBinomialMixedGPModel"),
            "negative_binomial_deepgp": ("bochan.models.regression.count.negative_binomial.deep", "DeepNegativeBinomialMixedGPModel"),
            "negative_binomial_deepkernel": ("bochan.models.regression.count.negative_binomial.deep", "DeepKernelNegativeBinomialMixedGPModel"),
            "negative_binomial_saas": ("bochan.models.regression.count.negative_binomial.high_dim", "SaasNegativeBinomialMixedGPModel"),
            "negative_binomial_pca": ("bochan.models.regression.count.negative_binomial.high_dim", "PCANegativeBinomialMixedGPModel"),
            "negative_binomial_rembo": ("bochan.models.regression.count.negative_binomial.high_dim", "REMBONegativeBinomialMixedGPModel"),
            "negative_binomial_rrp": ("bochan.models.regression.count.negative_binomial.robust", "RobustRelevancePursuitNegativeBinomialMixedGPModel"),
            "negative_binomial_hetero": ("bochan.models.regression.count.negative_binomial.robust", "HeteroscedasticNegativeBinomialMixedGPModel"),
        },
        "multi_objective": {
            "base": ("botorch.models.gp_regression_mixed", "MixedSingleTaskGP"),
            "kronecker": ("bochan.models.regression.gaussian", "GaussianMixedKroneckerMultiTaskGP"),
