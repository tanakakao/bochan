...
except Exception:  # pragma: no cover - BoTorch import support guard
    GetSampler = None  # type: ignore[assignment]
    SobolQMCNormalSampler = None  # type: ignore[assignment]


_KRONECKER_ORIGINAL_POSTERIOR_ATTR = "_bochan_original_posterior_before_q1_support"
_KRONECKER_ORIGINAL_LOGITS_ATTR = "_bochan_original_probability_logits_before_q1_support"
...
def _probability_to_objective_extended_shape(
    ...
    """Return BoTorch MO-supported extended shape for multiclass probabilities.
...
def apply_multiclass_posteriors() -> None:
    """Patch multiclass posterior wrappers for BoTorch sampler / NEHVI support."""
...
__all__ = ["apply_multiclass_posteriors"]
