...
from bochan.models.regression.beta.base.models import _BaseBetaGPModel, build_mixed_beta_kernel
...
class _DeepKernelBetaSVGP(ApproximateGP):
    """Deep Kernel Beta 用 latent SVGP。"""
    ...
    def __init__(
        ...
        *,
        ...
        self.feature_extractor = (
            feature_extractor
            or make_beta_feature_extractor(
                input_dim=input_dim,
...
class _DeepKernelMixedBetaSVGP(ApproximateGP):
    """mixed Deep Kernel Beta 用 latent SVGP。"""
...
class DeepKernelBetaGPModel(_BaseBetaGPModel):
    """Deep Kernel Learning 版 Beta GP。"""
...
class DeepKernelBetaMixedGPModel(_BaseBetaGPModel):
    """mixed Deep Kernel Learning 版 Beta GP。"""
