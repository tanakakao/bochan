...
from bochan.models.regression.beta._components import BetaMeanLink, BetaLogLikelihood, align_like, prepare_beta_targets
from bochan.models.regression.beta import BetaGPModel, BetaMixedGPModel
...
class SparseOutlierBetaLikelihood(BetaLogLikelihood, RelevancePursuitMixin):
    ...
    def __init__(
        ...
        *,
        ...
        BetaLogLikelihood.__init__(self, link=link, concentration=concentration, learn_concentration=learn_concentration, eps=eps, min_concentration=min_concentration)
