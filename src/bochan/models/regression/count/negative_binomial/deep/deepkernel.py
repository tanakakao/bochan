...
from bochan.models.regression.count.negative_binomial.base.models import (
...
def make_negative_binomial_feature_extractor(
    ...
    hidden_dims = (
        [max(input_dim * 8, output_dim), max(input_dim * 4, output_dim), max(input_dim * 2, output_dim)]
    ...
    def __init__(
        ...
        *,
        ...
        train_X_tf = apply_input_transform_for_training(
            train_X,
            input_transform,
            name="DeepKernelNegativeBinomialGPModel.input_transform",
        )
    ...
    def __init__(
        ...
        *,
        ...
        train_X_tf = apply_input_transform_for_training(
            ...
            input_transform,
            cat_dims=cat_dims,
            name="DeepKernelNegativeBinomialMixedGPModel.input_transform",
        )
        likelihood = likelihood or NegativeBinomialLogLikelihood(
            link=link,
            init_total_count=init_total_count,
