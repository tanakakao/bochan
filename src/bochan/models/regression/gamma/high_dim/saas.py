...
from bochan.models.regression.gamma._components import GammaLink
...
def build_map_saas_gamma_covar_module(
    train_X: Tensor,
    *,
    ...
    """Gamma latent GP 用の MAP-SAAS Matern kernel を作る。"""
...
class SaasGammaGPModel(GammaGPModel):
    """MAP-SAAS kernel を使う Gamma GP 回帰モデル。"""
    ...
    def __init__(
        ...
        *,
        ...
        if covar_module is None:
            covar_module = build_map_saas_gamma_covar_module(
                train_X=train_X,
                tau=tau,
...
class SaasGammaMixedGPModel(GammaMixedGPModel):
    """MAP-SAAS kernel を使う mixed Gamma GP 回帰モデル。"""
...
__all__ = [
    "build_map_saas_gamma_covar_module",
    "SaasGammaGPModel",
