...
from bochan.models.regression.beta.non_gaussian.beta import (
    BetaLogLikelihood,
    BetaPosterior,
...
from bochan.models.components.beta import prepare_beta_targets, clone_input_transform
...
class BetaGPModel(_AlignedBetaMixin, _BetaGPModel):
    """Beta GP model aligned with regression / ordinal wrapper conventions."""


class BetaMixedGPModel(_AlignedBetaMixin, _BetaMixedGPModel):
    """Mixed-input Beta GP model aligned with wrapper conventions."""
