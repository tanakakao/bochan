...
class GammaMultiTaskGPModel(ApproximateGPyTorchModel):
...
class WideGammaMultiTaskGPModel(GammaMultiTaskGPModel):
    """Gamma multi-task model whose wide targets may contain partial NaNs."""
