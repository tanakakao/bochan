...
@GetSampler.register(NegativeBinomialMultiTaskPosterior)
def _get_negative_binomial_multitask_sampler(
    posterior: NegativeBinomialMultiTaskPosterior,
    sample_shape: torch.Size,
    seed: int | None = None,
...
class _LatentNegativeBinomialMultiTaskSVGP(ApproximateGP):
