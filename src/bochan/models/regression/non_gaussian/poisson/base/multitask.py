...
from bochan.models.components.poisson import PoissonLink, PoissonLogLikelihood
...
class PoissonMultiTaskGPModel(ApproximateGPyTorchModel):
...
class WidePoissonMultiTaskGPModel(PoissonMultiTaskGPModel):
    """Poisson multi-task model whose wide targets may contain partial NaNs."""
