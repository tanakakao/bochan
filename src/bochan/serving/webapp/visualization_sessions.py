...
def _base_visualization_options(session: VisualizationSession) -> dict[str, Any]:
...
def _build_generic_visualization(run_id: str, request: dict[str, Any]) -> dict[str, Any]:
...
def build_visualization(run_id: str, request: dict[str, Any]) -> dict[str, Any]:
    ...
    return _build_generic_visualization(run_id, request)
