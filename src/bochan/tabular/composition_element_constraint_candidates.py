"""Candidate scoring helpers for repaired element-constrained compositions."""
...
class CompositionElementConstraintCandidateReranker:
    """Score repaired candidates without coupling the logic to an optimizer subclass."""

    @staticmethod
    def requested_q(opt_config: Any, kwargs: Mapping[str, Any]) -> int:
        """Resolve the requested public candidate batch size."""
    ...
    def rerank(
        ...
        *,
        ...
        """Re-score unique repaired candidates in transformed model coordinates."""
