...
class CompositionVariableTotalTransform:
    ...
    def formula_site_totals(
        ...
        """Return absolute site totals represented by formula values."""
    ...
    def site_totals_from_frame(
        ...
        *,
        ...
        """Resolve one site's absolute total from a source or transformed frame."""
    ...
    def prepare_multi_site_frame(
        ...
        *,
        ...
        """Transform composition coordinates and append variable-total features."""
    ...
    def replace_input_cols(
        ...
        *,
        ...
        """Replace source composition columns with model coordinates and totals."""
    ...
    def complete_bounds(
        ...
        *,
        ...
        """Add total-feature and fraction-coordinate bounds for variable sites."""
    ...
    def dynamic_search_space(
        ...
        """Build a repair search space at one candidate-specific total."""
    ...
    def inverse_compositions(
        ...
        *,
        ...
        """Restore candidate-specific absolute totals from model-space coordinates."""
