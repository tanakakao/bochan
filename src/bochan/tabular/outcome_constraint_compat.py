"""Outcome-constraint compatibility for tabular acquisition functions."""
...
class _TabularFeasibilityWeightedAcquisition:
    """Factory namespace for a posterior-compatible feasibility wrapper."""
    ...
    def build(*, acqf: Any, model: Any, constraints: list[Any], config: OutcomeConstraintConfig) -> Any:
        ...
        class PosteriorCompatibleFeasibilityWeightedAcquisition(FeasibilityWeightedAcquisition):
        ...
        return PosteriorCompatibleFeasibilityWeightedAcquisition(
            acqf=acqf,
            model=model,
...
def apply_tabular_outcome_constraint_compat() -> None:
    """Install tabular compatibility after the core API defaults are registered."""
...
__all__ = ["apply_tabular_outcome_constraint_compat"]
