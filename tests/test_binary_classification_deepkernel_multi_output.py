...
cases, optimizer / constraint scenarios, and Jupyter-oriented all-check runners
follow the base multi-output test design.
"""
...
def _fit_deepkernel_single_output_model(
    ...
    *,
    ...
    fit_deepkernel_mll(model.make_mll(), num_epochs=num_epochs, lr=lr)
...
def create_deepkernel_multi_output_binary_model_bundle(
    *,
    ...
    _assert_deepkernel_multi_output_model_training(model=model, train_x=train_x, train_y=train_y, cat_dims=cat_dims)
...
def deepkernel_multi_output_binary_model_bundle() -> dict[str, Any]:
    return create_deepkernel_multi_output_binary_model_bundle(cat=False, n=16, d=5, m=N_OUTPUTS, num_epochs=4)


@pytest.fixture(scope="module")
def deepkernel_multi_output_binary_mixed_model_bundle() -> dict[str, Any]:
    return create_deepkernel_multi_output_binary_model_bundle(cat=True, n=16, d=5, m=N_OUTPUTS, num_epochs=4)


def test_deepkernel_multi_output_binary_model_basic_behavior(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
...
def test_deepkernel_multi_output_binary_mixed_model_basic_behavior(deepkernel_multi_output_binary_mixed_model_bundle: dict[str, Any]) -> None:
    _assert_deepkernel_multi_output_model_training(
...
def test_deepkernel_multi_output_binary_acquisition_forward_shapes(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_model_bundle["train_x"]
...
def test_deepkernel_multi_output_binary_mixed_acquisition_forward_shapes(deepkernel_multi_output_binary_mixed_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_mixed_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_mixed_model_bundle["train_x"]
    X = make_random_mixed_batch(deepkernel_multi_output_binary_mixed_model_bundle["bounds"], deepkernel_multi_output_binary_mixed_model_bundle["cat_dims"], batch_size=4, q=2)
    for acq_cls, kwargs, case_id in multi_output_acquisition_cases(model, train_x):
        out = acq_cls(model=model, **kwargs)(X)
        assert out.shape == torch.Size([4]), case_id
        assert torch.isfinite(out).all(), case_id
...
def test_deepkernel_multi_output_binary_family_case_coverage(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_model_bundle["train_x"]
...
def test_deepkernel_multi_output_binary_constraint_scenario_coverage(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_model_bundle["train_x"]
...
@pytest.mark.slow
def test_deepkernel_multi_output_binary_optimize_acqf_representative_smoke(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_model_bundle["train_x"]
    bounds = deepkernel_multi_output_binary_model_bundle["bounds"]
    q = 2
...
@pytest.mark.slow
def test_deepkernel_multi_output_binary_mixed_optimize_acqf_mixed_representative_smoke(deepkernel_multi_output_binary_mixed_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_mixed_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_mixed_model_bundle["train_x"]
...
@pytest.mark.slow
def test_deepkernel_multi_output_binary_optimizer_constraint_case_smoke(deepkernel_multi_output_binary_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_model_bundle["train_x"]
    bounds = deepkernel_multi_output_binary_model_bundle["bounds"]
    q = 2
...
@pytest.mark.slow
def test_deepkernel_multi_output_binary_mixed_optimizer_constraint_case_smoke(deepkernel_multi_output_binary_mixed_model_bundle: dict[str, Any]) -> None:
    model = deepkernel_multi_output_binary_mixed_model_bundle["model"]
    train_x = deepkernel_multi_output_binary_mixed_model_bundle["train_x"]
    bounds = deepkernel_multi_output_binary_mixed_model_bundle["bounds"]
    cat_id = deepkernel_multi_output_binary_mixed_model_bundle["cat_dims"][0]
...
def run_jupyter_optimize_all_acquisitions_check(
    *,
    ...
    print("=" * 100)
    print(f"Jupyter DeepKernel {prefix}multi-output optimize check: all acquisitions")
...
def run_jupyter_optimizer_constraint_compatibility_check(
    *,
    ...
    print("=" * 100)
    print(f"Jupyter DeepKernel {prefix}multi-output optimizer / constraint compatibility check")
...
def run_jupyter_all_checks(
    *,
    ...
    """DeepKernel multi-output binary classification の Jupyter 一括確認 helper。"""
    ...
    print("all DeepKernel multi-output binary Jupyter checks passed.")
