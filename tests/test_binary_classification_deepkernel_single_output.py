...
def run_jupyter_forward_check(
    *,
    ...
    bundle = create_binary_deepkernel_model_bundle(cat=cat, n=n, d=d, num_epochs=num_epochs)
    model = bundle["model"]
...
def run_jupyter_optimize_acqf_all_acquisitions_check(
    *,
    ...
    bundle = create_binary_deepkernel_model_bundle(cat=False, n=n, d=d, num_epochs=num_epochs)
    model = bundle["model"]
    train_x = bundle["train_x"]
    bounds = bundle["bounds"]
...
def run_jupyter_optimize_acqf_mixed_all_acquisitions_check(
    *,
    ...
    bundle = create_binary_deepkernel_model_bundle(cat=True, n=n, d=d, num_epochs=num_epochs)
    model = bundle["model"]
    train_x = bundle["train_x"]
    bounds = bundle["bounds"]
