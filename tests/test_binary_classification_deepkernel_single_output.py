...
def test_binary_deepkernel_mixed_acquisition_forward_shapes(binary_deepkernel_mixed_model_bundle: dict[str, Any]) -> None:
    ...
    X = make_random_mixed_batch(binary_deepkernel_mixed_model_bundle["bounds"], binary_deepkernel_mixed_model_bundle["cat_dims"], batch_size=4, q=2)
...
@pytest.mark.slow
def test_binary_deepkernel_acquisition_optimize_acqf_smoke(binary_deepkernel_model_bundle: dict[str, Any]) -> None:
    model = binary_deepkernel_model_bundle["model"]
    train_x = binary_deepkernel_model_bundle["train_x"]
...
@pytest.mark.slow
def test_binary_deepkernel_mixed_acquisition_optimize_acqf_smoke(binary_deepkernel_mixed_model_bundle: dict[str, Any]) -> None:
    model = binary_deepkernel_mixed_model_bundle["model"]
    train_x = binary_deepkernel_mixed_model_bundle["train_x"]
...
@pytest.mark.slow
def test_binary_deepkernel_optimizer_constraint_compatibility_smoke() -> None:
    bundle = create_binary_deepkernel_model_bundle(cat=False)
...
@pytest.mark.slow
def test_binary_deepkernel_mixed_optimizer_constraint_compatibility_smoke() -> None:
    bundle = create_binary_deepkernel_model_bundle(cat=True)
    model, train_x, bounds = bundle["model"], bundle["train_x"], bundle["bounds"]
    q, d = 2, train_x.shape[-1]
